...
const styles = StyleSheet.create({
  ...
  greeting: { fontSize: 20, fontWeight: '700', color: '#185a9d', fontFamily: 'Poppins_700Bold' },
  ...
  sectionTitle: { fontSize: 18, fontWeight: 'bold', marginTop: 18, marginBottom: 8, color: '#1976d2', fontFamily: 'Poppins_700Bold' },
  ...
  statsValue: { fontWeight: 'bold', color: '#1976d2', fontFamily: 'Montserrat_700Bold' },
