...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 24, fontWeight: '700', color: '#185a9d', fontFamily: 'Urbanist_700Bold' },
  liveChip: { backgroundColor: '#bbf7d0', borderRadius: 16, marginRight: 8, paddingHorizontal: 10, paddingVertical: 0, alignItems: 'center' },
  liveChipText: { color: '#22c55e', fontWeight: 'bold', fontFamily: 'Urbanist_700Bold' },
  ...
  mapUpdatedText: { color: '#1976d2', fontSize: 13, fontWeight: '700', fontFamily: 'Urbanist_700Bold' },
  ...
  refreshText: { color: '#1976d2', fontWeight: '700', fontFamily: 'Urbanist_700Bold', fontSize: 14 },
  ...
  trafficLevel: { fontSize: 16, fontWeight: 'bold', color: '#185a9d', fontFamily: 'Urbanist_700Bold' },
  ...
  trafficDelay: { fontSize: 13, fontWeight: 'bold', fontFamily: 'Urbanist_700Bold' },
  ...
  updateTitle: { fontSize: 16, fontWeight: 'bold', color: '#185a9d', fontFamily: 'Urbanist_700Bold' },
  ...
  updateImpact: { fontSize: 13, fontWeight: 'bold', fontFamily: 'Urbanist_700Bold' },
  ...
  popularRouteText: { fontSize: 15, color: '#185a9d', fontWeight: '700', fontFamily: 'Urbanist_700Bold', marginHorizontal: 2 },
  popularArrow: { color: '#b0bec5', fontSize: 17, marginHorizontal: 2 },
  popularTime: { fontSize: 16, fontWeight: 'bold', color: '#185a9d', fontFamily: 'Urbanist_700Bold' },
  ...
  popularStatus: { fontSize: 13, fontWeight: 'bold', fontFamily: 'Urbanist_700Bold' },
  ...
  transitTitle: { fontSize: 16, fontWeight: 'bold', color: '#185a9d', fontFamily: 'Urbanist_700Bold' },
  transitStatus: { borderRadius: 10, paddingHorizontal: 8, paddingVertical: 2, marginLeft: 8 },
  transitStatusText: { fontSize: 13, fontWeight: 'bold', fontFamily: 'Urbanist_700Bold' },
